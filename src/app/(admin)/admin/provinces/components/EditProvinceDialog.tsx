...
export default function EditProvinceDialog({
  open, onClose, onSave, saving, province,
}: Props) {
    ...
    return (
        ...
        >
            ...
            >
                <Button onClick={onClose} sx={{ textTransform: "none", color: "var(--background)", backgroundColor: "var(--headline)" }}>Batal</Button>
                <Button
                    variant="contained"
                    onClick={() => onSave(form)}
                    disabled={saving}
