...
export default function EditDisasterDialog({
  open, onClose, onSave, saving, disaster,
}: Props) {
      ...
      <DialogContent dividers>
        ...
        >
          {imagePreview ? (
            ...
            <Box component="img" src={disaster.image} alt="current"
          ...
          <Typography variant="body2" color="text.secondary">
            {imageFile ? imageFile.name : "Klik untuk ganti gambar"}
          </Typography>
        ...
        {form.causes.map((c, i) => (
          <Box key={i} className="flex items-center gap-2 mb-1">
            <TextField fullWidth size="small" value={c} sx={{ ...TEXTFIELD_SX }}
